...
@Component({
  selector: 'app-flag-option',
  templateUrl: './flag-option.component.html',
  // template: `
  //   <div class="option-container">
  //     <img [src]="img" alt="{{ name }}" class="flag-icon" />
  //     <span>{{ name }}</span>
  //   </div>
  // `,
  styleUrls: ['./flag-option.component.scss'],
})
export class FlagOptionComponent{
  ...
  countries = [ 
    ...
    {
    "name": "Honduras",
    "flag": "https://upload.wikimedia.org/wikipedia/commons/8/8c/Flag_of_Honduras_%28darker_variant%29.svg",
    "number": "+504"
    },
    {
    "name": "Hong Kong",
    ...
    {
    "name": "Swaziland",
    "flag": "https://en.wikipedia.org/wiki/Eswatini#/media/File:Flag_of_Eswatini.svg",
    "number": "+268"
    },
    {
    "name": "Sweden",
  ...
  ngOnInit() {
    ...
    this.selectedCountry = this.countries[92].flag;
  }

  onSelectCountry(data:any) {
    this.selectedCountry = data.flag;
  }
